...
// export class DialogueStats extends HTMLElement {
// 	constructor() {
...
// 		descriptionContainer.classList.add('dialogue-description');
...
// 		shadow.appendChild(descriptionContainer);
// 	  }
...
// 	customElements.define('dialogue-stats', DialogueStats);
// }
